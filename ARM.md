...
It is assumed server is running inside an Oracle Cloud instance, and the provider uses that identity for authentication.
...
Check and look for releases marked as `deployed`:
